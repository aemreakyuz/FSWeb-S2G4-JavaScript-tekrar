...
*/
var ucebolunenlerintoplami = ucetambolunenler.reduce((total, number) => {
  return total + number;
}, 0);
...
var besyuzdenkucuksayilar = sayilar.filter((number) => {
  return number < 500;
});
console.log(besyuzdenkucuksayilar);
...
var siralisayilar = [...besyuzdenkucuksayilar].sort((a, b) => {
  return a - b;
});
...
tekraredensayilar = []; // map veya reduce ile yapılabilir
...
console.log("3f", sayiVeTekrarSayisi);
...
//BONUS: ucetambolunenler dizisindeki ilk 20 sayı için, 3e bölünebilen sayılar için "Fizz", 5'e bölünebilen sayılar için "Buzz", hem 3'e hem 5'e için "FizzBuzz"
...
for (let i = 0; i < 20; i++) {
  ...
  console.log(" FizzBuzz", ucetambolunenler[i], str);
}
